                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == 0) {
                        ...
                        } else if (index == surveyDetails.length + 1) {
                          //tambahan
                          return Column(
                            children: [
                          ...
                          final survey = surveyDetails[index - 1]; //awalnya 0
                          return Padding(
                            ...
                            child: Dismissible(
                              ...
                              onDismissed: (direction) {
                                try {
                                  HttpSurveyDetails()
                                      .deleteRespondent(survey.id);
                                  setState(() {
                                    surveyDetails
                                        .removeAt(index - 1); //awalnya 0
                                  });
                                } catch (e) {
